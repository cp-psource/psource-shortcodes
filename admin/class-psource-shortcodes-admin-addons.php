...
final class Shortcodes_Ultimate_Admin_Addons extends Shortcodes_Ultimate_Admin {
	...
	public function admin_menu() {
		...
		$this->add_submenu_page(
			'psource-shortcodes',
			__( 'Add-ons', 'psource-shortcodes' ),
			__( 'Add-ons', 'psource-shortcodes' ),
			$this->get_capability(),
			'psource-shortcodes-addons',
	...
	public function add_help_tab( $screen ) {
		...
		$screen->add_help_tab( array(
				'id'      => 'psource-shortcodes-addons',
				'title'   => __( 'Add-ons', 'psource-shortcodes' ),
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_style( 'psource-shortcodes-admin', $this->get_plugin_url() . 'admin/css/admin.css', array(), $this->get_plugin_version() );
