...
<div class="su-admin-shortcodes-single-section su-admin-shortcodes-single-description wp-clearfix">
	...
	<p>
		...
		<?php if ( isset( $data['article'] ) ) : ?>
			<br><a href="<?php echo esc_url( $data['article'] ); ?>" target="_blank"><strong><?php esc_html_e( 'Shortcode-Dokumentation', 'upfront-shortcodes' ); ?></strong></a>.
		<?php endif; ?>
	</p>
</div>
<!-- /Description section -->
...
<div class="su-admin-shortcodes-single-section su-admin-shortcodes-single-preview">
	<h2><?php esc_html_e( 'Vorschau', 'upfront-shortcodes' ); ?></h2>
...
<div class="su-admin-shortcodes-single-section su-admin-shortcodes-single-code">
	<h2><?php esc_html_e( 'Shortcode', 'upfront-shortcodes' ); ?></h2>
...
<div class="su-admin-shortcodes-single-section su-admin-shortcodes-single-options">
	<h2><?php esc_html_e( 'Shortcode-Optionen', 'upfront-shortcodes' ); ?></h2>
	...
	<?php foreach ( $this->get_single_shortcode_options() as $table ) : ?>
		...
		<div class="su-admin-shortcodes-single-options-table">
			...
			<?php if ( ! is_array( $table['atts'] ) || ! count( $table['atts'] ) ) : ?>
				<p class="description"><?php esc_html_e( 'Dieser Shortcode hat keine Optionen', 'upfront-shortcodes' ); ?></p>
			<?php else : ?>

				<table class="widefat striped">

					<tr>
						<th><?php esc_html_e( 'Optionsname', 'upfront-shortcodes' ); ?></th>
						<th><?php esc_html_e( 'Mögliche Werte', 'upfront-shortcodes' ); ?></th>
						<th><?php esc_html_e( 'Standardwert', 'upfront-shortcodes' ); ?></th>
					</tr>
