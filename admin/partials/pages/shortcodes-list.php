...
<div class="wp-filter">
	...
	<form class="search-form" action="<?php echo $this->component_url; ?>">
		<label class="screen-reader-text" for="wp-filter-search-input"><?php _e( 'Search shortcodes', 'psource-shortcodes' ); ?></label>
		<input placeholder="<?php _e( 'Search shortcodes', 'psource-shortcodes' ); ?>&hellip;" type="search" id="wp-filter-search-input" class="wp-filter-search">
	</form>
	*/ ?>
</div>
...
<div class="su-admin-shortcodes-list wp-clearfix">
	...
	<?php else : ?>
		<p class="su-admin-shortcodes-list-not-found"><?php _e( 'No shortcodes found.', 'psource-shortcodes' ); ?></p>
	<?php endif; ?>
