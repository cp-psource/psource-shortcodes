...
<div class="su-admin-shortcodes-single">
	...
	<div class="su-admin-shortcodes-single-section su-admin-shortcodes-single-back">
		<a href="<?php echo $this->get_component_url(); ?>" class="button"><span class="dashicons dashicons-arrow-left-alt"></span> <?php _e( 'Back to shortcodes list', 'psource-shortcodes' ); ?></a>
	</div>
	<!-- /"Go back" button -->
	...
	<?php if ( $shortcode ) : ?>
		...
		<div class="su-admin-shortcodes-single-section su-admin-shortcodes-single-description wp-clearfix">
			...
			<p>
				...
				<?php if ( isset( $shortcode['article'] ) ) : ?>
					<br><a href="<?php echo esc_url( $shortcode['article'] ); ?>" target="_blank"><strong><?php _e( 'Shortcode documentation', 'psource-shortcodes' ); ?></strong></a>.
				<?php endif; ?>
			</p>
		</div>
		<!-- /Description section -->
		...
		<div class="su-admin-shortcodes-single-section su-admin-shortcodes-single-preview">
			<h2><?php _e( 'Preview', 'psource-shortcodes' ); ?></h2>
		...
		<div class="su-admin-shortcodes-single-section su-admin-shortcodes-single-code">
			<h2><?php _e( 'Shortcode', 'psource-shortcodes' ); ?></h2>
		...
		<div class="su-admin-shortcodes-single-section su-admin-shortcodes-single-options">
			<h2><?php _e( 'Shortcode options', 'psource-shortcodes' ); ?></h2>
			...
			<?php foreach( $options as $table ) : ?>
				...
				<div class="su-admin-shortcodes-single-options-table">
					...
					<?php if ( !is_array( $table['atts'] ) || !count( $table['atts'] ) ) : ?>
						<p class="description"><?php _e( 'This shortcode do not have options', 'psource-shortcodes' ); ?></p>
					<?php else : ?>

						<table class="widefat striped">

							<tr>
								<th><?php _e( 'Option name', 'psource-shortcodes' ); ?></th>
								<th><?php _e( 'Possible values', 'psource-shortcodes' ); ?></th>
								<th><?php _e( 'Default value', 'psource-shortcodes' ); ?></th>
							</tr>
