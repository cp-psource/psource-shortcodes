...
<div class="su-admin-about wrap">
	...
	<div class="su-admin-about-page-header">
		...
		<h1>
			...
			<?php echo esc_html( sprintf( __( 'Welcome to %s', 'upfront-shortcodes' ), 'Shortcodes&nbsp;Ultimate' ) ); ?>
		</h1>
	...
	<div class="su-admin-about-getting-started">
		<div class="su-admin-about-getting-started-video su-admin-about-getting-started-video-loading" id="su-admin-about-getting-started-video">
			<button class="su-admin-about-getting-started-video-button su-admin-u-hidden" id="su-admin-about-getting-started-video-button">
				...
				<span><?php esc_html_e( 'See the plugin in action', 'upfront-shortcodes' ); ?></span>
			</button>
	...
	<div class="su-admin-about-popular">
		...
		<p><?php esc_html_e( 'The plugin includes over 60 amazing shortcodes', 'upfront-shortcodes' ); ?></p>
		<ul class="su-admin-about-popular-grid">
			<?php foreach ( su_get_config( 'popular-shortcodes' ) as $shortcode ) : ?>
				<li class="su-admin-about-popular-item">
					<img class="su-admin-about-popular-item-icon" src="<?php echo esc_attr( su_get_plugin_url() . $shortcode['icon'] ); ?>" alt="<?php echo esc_attr( sprintf( '%s: %s', __( 'Shortcode icon', 'upfront-shortcodes' ), $shortcode['title'] ) ); ?>" width="24" height="24">
		...
		<div class="su-admin-about-popular-bottom">
			<a href="https://getshortcodes.com/docs-category/shortcodes/" class="button" target="_blank"><?php esc_html_e( 'View all shortcodes', 'upfront-shortcodes' ); ?> <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="16" height="16" fill="none" stroke="currentcolor" stroke-linecap="round" stroke-linejoin="round" stroke-width="3"><path d="M14 9 L3 9 3 29 23 29 23 18 M18 4 L28 4 28 14 M28 4 L14 18" /></svg></a>
		</div>
	</div>

	<div class="su-admin-about-upgrade">
		<div class="su-admin-about-upgrade-features">
			<h2><?php esc_html_e( 'Premium Add-ons', 'upfront-shortcodes' ); ?></h2>
			<ul>
				<li><?php esc_html_e( 'Parallax Section shortcode', 'upfront-shortcodes' ); ?></li>
				<li><?php esc_html_e( 'Custom PHP shortcodes', 'upfront-shortcodes' ); ?></li>
				<li><?php esc_html_e( 'Content Slider shortcode', 'upfront-shortcodes' ); ?></li>
				<li><?php esc_html_e( 'Personal email support', 'upfront-shortcodes' ); ?></li>
				<li><?php esc_html_e( 'Testimonail shortcode', 'upfront-shortcodes' ); ?></li>
				<li><?php esc_html_e( '24 styles for Heading', 'upfront-shortcodes' ); ?></li>
				<li><?php esc_html_e( 'Progress Bar shortcode', 'upfront-shortcodes' ); ?></li>
				<li><?php esc_html_e( '14 styles for Spoiler', 'upfront-shortcodes' ); ?></li>
				<li><?php esc_html_e( 'Exit Popup shortcode', 'upfront-shortcodes' ); ?></li>
				<li><?php esc_html_e( '13 styles for Tabs', 'upfront-shortcodes' ); ?></li>
			</ul>
		</div>
			...
			<ul>
				<li>
					<a href="https://getshortcodes.com/docs/" target="_blank">
						...
						<?php esc_html_e( 'Plugin documentation', 'upfront-shortcodes' ); ?>
					</a>
				</li>
				<li>
					<a href="https://wordpress.org/support/plugin/upfront-shortcodes/" target="_blank">
						...
						<?php esc_html_e( 'Community support forum', 'upfront-shortcodes' ); ?>
					</a>
				</li>
				<li>
					<a href="https://getshortcodes.com/support/open-support-ticket/" target="_blank">
						...
						<?php esc_html_e( 'Premium support', 'upfront-shortcodes' ); ?>
					</a>
				</li>
			</ul>
		</div>
