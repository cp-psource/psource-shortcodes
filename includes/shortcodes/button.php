	...
	array(
		...
		'atts'     => array(
			...
			'target'      => array(
				...
				'desc'    => __( 'Button link target', 'upfront-shortcodes' ),
			),
			'style'       => array(
				'type'    => 'select',
				'values'  => array(
					...
					'ghost'   => __( 'Ghost', 'upfront-shortcodes' ),
					...
					'stroked' => __( 'Stroked', 'upfront-shortcodes' ),
					'3d'      => __( '3D', 'upfront-shortcodes' ),
				),
				'default' => 'default',
				'name'    => __( 'Style', 'upfront-shortcodes' ),
				'desc'    => __( 'Button background style preset', 'upfront-shortcodes' ),
			),
			'background'  => array(
				'type'    => 'color',
				'values'  => array(),
				...
				'desc'    => __( 'Button background color', 'upfront-shortcodes' ),
			),
			'color'       => array(
				'type'    => 'color',
				'values'  => array(),
				...
				'desc'    => __( 'Button text color', 'upfront-shortcodes' ),
			),
			'size'        => array(
				'type'    => 'slider',
				'min'     => 1,
				...
				'desc'    => __( 'Button size', 'upfront-shortcodes' ),
			),
			'wide'        => array(
				'type'    => 'bool',
				'default' => 'no',
				'name'    => __( 'Fluid', 'upfront-shortcodes' ),
				'desc'    => __( 'Fluid buttons has 100% width', 'upfront-shortcodes' ),
			),
			'center'      => array(
				'type'    => 'bool',
				'default' => 'no',
				'name'    => __( 'Centered', 'upfront-shortcodes' ),
				'desc'    => __( 'Is button centered on the page', 'upfront-shortcodes' ),
			),
			'radius'      => array(
				'type'    => 'select',
				'values'  => array(
					'auto'  => __( 'Auto', 'upfront-shortcodes' ),
					'round' => __( 'Round', 'upfront-shortcodes' ),
					'0'     => __( 'Square', 'upfront-shortcodes' ),
					'5'     => '5px',
					'10'    => '10px',
					'20'    => '20px',
				),
				...
				'desc'    => __( 'Radius of button corners. Auto-radius calculation based on button size', 'upfront-shortcodes' ),
			),
			'icon'        => array(
				'type'    => 'icon',
				'default' => '',
				'name'    => __( 'Icon', 'upfront-shortcodes' ),
				'desc'    => __( 'You can upload custom icon for this button or pick a built-in icon', 'upfront-shortcodes' ),
			),
			'icon_color'  => array(
				'type'    => 'color',
				'default' => '#FFFFFF',
			...
			'text_shadow' => array(
				'type'    => 'shadow',
				'default' => 'none',
				'name'    => __( 'Text shadow', 'upfront-shortcodes' ),
				'desc'    => __( 'Button text shadow', 'upfront-shortcodes' ),
			),
			'desc'        => array(
				'default' => '',
			...
			'download'    => array(
				...
				'desc'    => __( 'The download attribute specifies that the button URL will be downloaded when a user clicks on the button. The value of the attribute will be the name of the downloaded file.', 'upfront-shortcodes' ),
			),
			'onclick'     => array(
				'default' => '',
				'name'    => __( 'onClick', 'upfront-shortcodes' ),
				'desc'    => __( 'Advanced JavaScript code for onClick action', 'upfront-shortcodes' ),
			),
			'rel'         => array(
				'default' => '',
				'name'    => __( 'Rel attribute', 'upfront-shortcodes' ),
				'desc'    => __( 'Here you can add value for the rel attribute.<br>Example values: <b%value>nofollow</b>, <b%value>lightbox</b>', 'upfront-shortcodes' ),
			),
			'title'       => array(
				'default' => '',
				'name'    => __( 'Title attribute', 'upfront-shortcodes' ),
				'desc'    => __( 'Here you can add value for the title attribute', 'upfront-shortcodes' ),
			),
			'id'          => array(
				'default' => '',
				'name'    => __( 'Button ID', 'upfront-shortcodes' ),
				'desc'    => __( 'Custom value for the ID attribute', 'upfront-shortcodes' ),
			),
			'class'       => array(
		...
		'content'  => __( 'Button text', 'upfront-shortcodes' ),
		'desc'     => __( 'Styled button', 'upfront-shortcodes' ),
		'example'  => 'buttons',
		'icon'     => 'heart',
	)
);
