	...
	array(
		...
		'atts'     => array(
			...
			'open'          => array(
				...
				'desc'    => __( 'Spoilerinhalt ist standardmäßig sichtbar', 'upfront-shortcodes' ),
			),
			'style'         => array(
				'type'    => 'select',
				'values'  => array(
			...
			'anchor'        => array(
				...
				'desc'    => __( 'Du kannst einen einzigartigen Anker für diesen Spoiler verwenden, um mit Hash in der Seiten-URL darauf zuzugreifen. Gib hier <b%value>Hallo</b> ein und verwende dann eine URL wie http://example.com/page-url#Hallo. Dieser Spoiler wird geöffnet und gescrollt', 'upfront-shortcodes' ),
			),
			'anchor_in_url' => array(
				'type'    => 'bool',
				'default' => 'no',
		...
		'note'     => __( 'Wusstest Du, dass Du mehrere Spoiler mit dem Shortcode [accordeon] umschließen kannst, um einen Akkordeoneffekt zu erzielen?', 'upfront-shortcodes' ),
		'example'  => 'spoilers',
		'icon'     => 'list-ul',
