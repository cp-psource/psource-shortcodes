...
su_add_shortcode(
	array(
		...
		'name'     => __( 'List', 'upfront-shortcodes' ),
		'type'     => 'wrap',
		'group'    => 'content',
		'atts'     => array(
			'icon'       => array(
				...
				'desc'    => __( 'You can upload custom icon for this list or pick a built-in icon', 'upfront-shortcodes' ),
			),
			'icon_color' => array(
				'type'    => 'color',
				'default' => '#333333',
			...
			'indent'     => array(
				...
				'min'     => -100,
				'max'     => 100,
				'name'    => __( 'Indent', 'upfront-shortcodes' ),
				'desc'    => __( 'Defines list indent size (in pixels). Negative numbers are also allowed', 'upfront-shortcodes' ),
			),
			'class'      => array(
		...
		'desc'     => __( 'Styled unordered list', 'upfront-shortcodes' ),
		'icon'     => 'list-ol',
	)
);
