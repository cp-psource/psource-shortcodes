...
function su_slide_link_input( $form_fields, $post ) {
	...
	$form_fields['su_slide_link'] = array(
		...
		'helps' => sprintf(
			...
			__( 'UpFront Shortcodes', 'upfront-shortcodes' ),
			__( 'Verwende dieses Feld, um benutzerdefinierte Links zu Folien hinzuzufügen, die mit Slider-, Karussell- und benutzerdefinierten Galerie-Shortcodes verwendet werden', 'upfront-shortcodes' )
		),
	);
